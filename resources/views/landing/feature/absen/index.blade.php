...
@push('script')
    <!-- Preload & Prefetch model files agar download super cepat -->
    <link rel="prefetch" href="/faceapi/models/ssd_mobilenetv1_model-shard1" as="fetch" crossorigin="anonymous">
    <link rel="prefetch" href="/faceapi/models/ssd_mobilenetv1_model-shard2" as="fetch" crossorigin="anonymous">
    <link rel="prefetch" href="/faceapi/models/face_landmark_68_model-shard1" as="fetch" crossorigin="anonymous">
    <link rel="prefetch" href="/faceapi/models/face_recognition_model-shard1" as="fetch" crossorigin="anonymous">
    <link rel="prefetch" href="/faceapi/models/face_recognition_model-shard2" as="fetch" crossorigin="anonymous">
    <link rel="prefetch" href="/faceapi/models/face_expression_model-shard1" as="fetch" crossorigin="anonymous">

    <!-- CSRF Token -->
    <meta name="csrf-token" content="{{ csrf_token() }}">

    <!-- Konfigurasi sekolah — diinject dari server, tidak hardcoded di JS -->
    <script>
        window.schoolConfig = {!! json_encode([
            'lat'    => config('school.latitude'),
            'lng'    => config('school.longitude'),
            'radius' => config('school.radius'),
        ]) !!};
        window.absenStoreUrl = "{{ route('feature.absen.store') }}";
    </script>
